...
class CoreuiLaravelServiceProvider extends ServiceProvider
{
    ...
    protected function configurePublishing()
    {
        ...
        $this->publishes([
            __DIR__.'/../stubs/resources/scss/app.scss' => resource_path('scss/app.scss'),
            ...
            __DIR__.'/../stubs/resources/scss/coreui-default-variables.scss' => resource_path('scss/coreui-default-variables.scss'),
            __DIR__.'/../stubs/resources/scss/coreui-default-maps.scss' => resource_path('scss/coreui-default-maps.scss'),
